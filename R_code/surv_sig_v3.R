...
clin_df <- clin_df[c("barcode", "patient", "vital_status", "days_to_death",
...
ggsurvplot(survfit(Surv(overall_survival, deceased) ~ ifng.rank, data = clin_df),
           palette = c("gray50", "blue1"),
           font.x = c(7),
           font.y = c(7),
           font.tickslab = c(7),
           font.legend = c(7),
           legend.title = c(""),
           legend.labs = c("IFNG/R lo", "IFNG/R hi"),
           xlab = c("Time (d)"),
           pval.size = 2.75,
           pval = T)
dev.off()
...
ggsurvplot(survfit(Surv(overall_survival, deceased) ~ trail.rank, data = clin_df),
           palette = c("gray50", "goldenrod1"),
           font.x = c(7),
           font.y = c(7),
           font.tickslab = c(7),
           font.legend = c(7),
           legend.title = c(""),
           legend.labs = c("TRAIL/R lo", "TRAIL/R hi"),
           xlab = c("Time (d)"),
           pval.size = 2.75,
           pval = T)
dev.off()
...
ggsurvplot(survfit(Surv(overall_survival, deceased) ~ ifng.rank + trail.rank,
                   data = clin_df),
           palette = c("slategray4", "darkgoldenrod1", "blue3", "green3"),
           font.x = c(7),
           font.y = c(7),
           font.tickslab = c(7),
           font.legend = c(7),
           legend.title = c(""),
           legend.labs = c("IFNG/R lo\nTRAIL/R lo",
                           "IFNG/R lo\nTRAIL/R hi",
                           "IFNG/R hi\nTRAIL/R lo",
                           "IFNG/R hi\nTRAIL/R hi"),
           xlab = c("Time (d)"),
